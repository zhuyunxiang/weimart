...
customReturnCtrls.controller('textReturnCtrl', ['$http', '$scope',
    function($http, $scope) {
        $scope.textInfo = {
...
// 图文回复
customReturnCtrls.controller('mediaReturnCtrl', ['$http', '$scope',
    function($http, $scope) {
       $scope.textInfo = {
            modalTitleText: '添加新记录',
        };
